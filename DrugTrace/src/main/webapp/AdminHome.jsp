    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <!-- <li><a class="" href="SendDrugApproval.jsp">View Notifications<i class="fa fa-bell cursor-pointer" style="font-size:16px"></i></a></li>         
          <li><a class="" href="ViewBatchDetails.jsp">View Batch Details</a></li>  -->
           <li class="dropdown">
           <a>View Users<i class="bi bi-chevron-down"></i></a>
         <ul> <li><a href="ViewSupplier.jsp">Supplier</a></li>
         <li><a href="ViewManufacturer.jsp">Manufacturer</a></li>
         <li><a href="ViewDistributors.jsp">Distributor</a></li>
         <li><a href="ViewPharmacyUser.jsp">Pharmacy</a></li>
