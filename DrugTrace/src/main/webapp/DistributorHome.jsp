    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <!--   <li><a href="ViewSupplier.jsp">View Supplier</a></li>
          <li><a href="">View Distributor</a></li> 	      -->              
          <li class="dropdown">
...
<div class="w3-container">  
  ...
  <!-- <button class="w3-button w3-black" style="width:200px;"><a href="BatchDetailsApproved1.jsp" style="color:white;">View Batch</a></button><br><br>
  <button class="w3-button w3-black" style="width:200px;"><a href="ViewAddDrug.jsp" style="color:white;">View All Drug</a></button><br><br>
    <button class="w3-button w3-black" style="width:200px;"><a href="ViewDistiPayment.jsp" style="color:white;">Payment Details</a></button><br><br>
<button class="w3-button w3-black" data-toggle="modal" data-target="#myModal3" style="width:200px;">Payment Details</button><br><br>
 -->
</div>
</div>
<div class="col-lg-8">
<img src="assets/img/Distributors.png" width="700px" height="400px">
