...
<br>
  ...
  <section id="pharmacyreg" class="pharmacyreg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title"><br>        
          <p>Pharmacy Login</p>
            ...
            <form action="PharmacyLoginCon" method="post">
         ...
         <a href="PharmacyReg.jsp" style="color:gold" >Not Register? Register here!!</a><br><br>
              </div>              
            </form>
          </div>
        </div>
