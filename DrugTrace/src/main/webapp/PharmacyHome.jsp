  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
       ...
       <!--  <li><a class="active" href="ViewBuyMedicine.jsp"><i class="fa fa-bell" style="font-size:18px"></i>Notification</a></li>               
         -->  
          <li class="dropdown">
...
<!--   <button class="w3-button w3-black" style="width:200px;"><a href="BatchDetailsApproved2.jsp" style="color:white;" style="width:200px;">View Stock</a></button><br><br>
  <button class="w3-button w3-black" style="width:200px;"><a href="ViewAddDrug.jsp" style="color:white;" style="width:200px;">View All Drug</a></button><br><br>
    <button class="w3-button w3-black" style="width:200px;"><a href="PaymentPharmHome.jsp" style="color:white;">Payment</a></button><br><br>
 -->
</div>
</div>
<div class="col-lg-8">
<img src="assets/img/pharmacy.jpg" width="700px" height="400px">
      ...
      <div class="modal-content">  
        <div class="modal-header">  
         <!--  <button type="button" class="close" data-dismiss="modal">×</button>   -->
          <h4 class="modal-title" align="center">Add Drug Stock</h4>  
        </div>  
        <div class="modal-body" align="center">  
        
        <form action="AddDrugStockCon" method="post" enctype="multipart/form-data">
           ...
           <div class="form-group mt-1">
            ...
            <div class="form-group mt-1">
             <input type="text" name="drugname" required pattern="[a-zA-Z\s]+" title="Enter Your Drug Name" class="form-control custom-labels" required="required"  placeholder="Enter Drug Name" />                                
               ...
               <div class="form-group mt-1">
                <input type="text" name="quantityofdrug" class="form-control custom-labels" required="required" placeholder="Enter quantity of drug" />
              </div> 
  ...
  <div class="modal fade" id="myModal3" role="dialog">  
    <div class="modal-dialog">  
      ...
      <div class="modal-content">  
        <div class="modal-header">  
         <!--  <button type="button" class="close" data-dismiss="modal">×</button>   -->
          <h4 class="modal-title" align="center">Packaging Drug</h4>  
        </div>  
        <div class="modal-body" align="center">  
        ...
        <form action="PaymentCon" method="post">
            ...
            <div class="form-group mt-1">
             <input type="text" name="packageName" required pattern="[a-zA-Z\s]+" title="Enter Supplier Name" class="form-control custom-labels" required="required"  placeholder="Enter Supplier Name" />                                
                </div>
            <div class="form-group mt-1">
             <input type="text" name="weight" required pattern="[a-zA-Z\s]+" title="Enter Row Material Name" class="form-control custom-labels" required="required"  placeholder="Enter Row Material Name" />                                
                </div>             
                <div class="form-group mt-1 mt-1 mt-md-0">
                <input type="text" name="accountno" class="form-control custom-labels" title="Enter Accountno" required="required" placeholder="Enter Account No" />
              </div>
